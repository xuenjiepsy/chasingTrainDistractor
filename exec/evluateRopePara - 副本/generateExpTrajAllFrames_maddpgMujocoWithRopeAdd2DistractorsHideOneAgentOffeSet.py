...
def generateSingleCondition(condition):
    ...
    modelSaveName = 'expTrajMADDPGMujocoEnvNovModifyMasterReward'
    ...
    masterID = [2]
    distractorID = [3,4]
    hideIdList = [5]# distractorID + sheepsID
    numAgent=5
    ...
    for hideId in hideIdList:
        ...
        if saveTraj:
            ...
            trajectoriesSaveDirectory= os.path.join(dataFolder,'trajectory',modelSaveName,'noiseOffsetMasterForSelectOct14')
            ...
            expTrajectoriesSaveDirectory = os.path.join(dataFolder, 'Exptrajectory', modelSaveName,'noiseOffsetMasterForSelectOct20')
        ...
        if visualizeTraj:
            ...
            pictureFolder = os.path.join(dataFolder, 'demo', modelSaveName,'normalOct','damping={}_frictionloss={}_killZoneRatio{}_masterForce={}_masterMass={}_ropeLength={}_ropePunishWeight={}_offset={}_hideId={}'.format(damping,frictionloss,killZoneRatio,masterForce,masterMass,ropeLength,ropePunishWeight,offset,hideId))
...
def main():
    ...
    manipulatedVariables['ropePunishWeight'] = [ 0.0]
    manipulatedVariables['ropeLength'] = [0.06] #ssr-1,Xp = 0.06; ssr-3 =0.09

    manipulatedVariables['masterMass'] = [5.0] #ssr-1, ssr-3 = 1.0; Xp = 2.0
    # manipulatedVariables['wolfMass'] = [1.0] #ssr-1, ssr-3 = 1.0; Xp = 2.0

    manipulatedVariables['offset'] =[0.0]

    manipulatedVariables['distractorNoise'] = [0.0,3.0,6.0,9.0]
